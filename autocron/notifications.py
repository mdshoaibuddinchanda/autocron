...
class EmailNotifier(Notifier):
    ...
    def send(self, title: str, message: str, **kwargs) -> bool:
        ...
        try:
            ...
            msg['To'] = self.to_email if isinstance(self.to_email, str) else ', '.join(self.to_email)
...
class NotificationManager:
    ...
    def notify_task_success(self, task_name: str, duration: float, channels: Optional[list] = None) -> Dict[str, bool]:
        """
        Notify task success.
    ...
    def notify_scheduler_error(self, error: str, channels: Optional[list] = None) -> Dict[str, bool]:
        """
